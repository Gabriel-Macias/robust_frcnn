...
def transform_img(x_img, height, width, C, backend):
	
	# Get image dimensions for resizing
	(resized_width, resized_height, f) = get_new_img_size(width, height, C.im_size)
		...
		for img_data in all_img_data:
			try:
				...
				if mode == 'train':
					...
					# Read in image, and add augmentation
					...
					x_img, _ = transform_img(x_img, height, width, C, backend)
					...
					x_img, f = transform_img(x_img, height, width, C, backend)
					
					yield np.copy(x_img), img_data["filepath"], width, height, f
