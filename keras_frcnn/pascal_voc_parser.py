...
def get_data(input_path, cat=None):
	...
	data_paths = [os.path.join(input_path,s) for s in ['VOC2012']] #add VOC2012 if using. - used to be 'VOC2007'
	...
	for data_path in data_paths:
		...
		if "VOCdevkit_test" not in data_path:
		...
		print("# trainval files = {}, # test files = {}".format(len(trainval_files), len(test_files)))
