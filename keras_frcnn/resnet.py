...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    x = TimeDistributed(AveragePooling2D((7, 7), name='avg_pool'), name = "time_distributed_1")(x)
    out = TimeDistributed(Flatten(name='flatten'), name = "time_distributed_2")(x)
    out = TimeDistributed(Dense(4096, activation='relu', name='fc1'), name = "time_distributed_3")(out)
    out = TimeDistributed(Dropout(0.5), name = "time_distributed_4")(out)
    out = TimeDistributed(Dense(4096, activation='relu', name='fc2'), name = "time_distributed_5")(out)
    out = TimeDistributed(Dropout(0.5), name = "time_distributed_6")(out)
