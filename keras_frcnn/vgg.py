...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    out_roi_pool = RoiPoolingConv(pooling_regions, num_rois, name = "roi_pooling_conv_1")([base_layers, input_rois])
    ...
    out = TimeDistributed(Dropout(0.5), name = "time_distributed_3")(out, training=trainable)
    out = TimeDistributed(Dense(4096, activation='relu', name='fc2'), name = "time_distributed_4")(out)
    out = TimeDistributed(Dropout(0.5), name = "time_distributed_5")(out, training=trainable)
